...
def save_contacts(list):
    file = open('D:/Source/Python_review/Feb_06_Mon/contacts.txt','w',
...
def load_contacts(list):
    try:
        file = open('D:/Source/Python_review/Feb_06_Mon/contacts.txt','r',
                encoding='utf-8')   # 읽어오는거라 타입 r
    except Exception as e: # 24-1 파일 없을때 나는 예외 => 이렇게하면 파일 생성하고 
        f = open('D:/Source/Python_review/Feb_06_Mon/contacts.txt','w',
                encoding='utf-8')
